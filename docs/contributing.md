...
strefi welcomes contributions from the community.
...
- Clone your fork of this repo. `git clone git@github.com:YOUR_GIT_USERNAME/strefi`
- Enter the directory `cd project_urlname`
- Add upstream repo `git remote add upstream https://github.com/VictorMeyer77/strefi.git`
